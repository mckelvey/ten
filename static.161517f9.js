...
/******/ 	__webpack_require__.p = "https://mckelvey.github.io/ten/";
/******/
...
exports.next = exports.previous = exports.currentIndex = exports.day = exports.summary = exports.series = exports.history = undefined;

var _get = __webpack_require__(12);

var _get2 = _interopRequireDefault(_get);

var _sortedIndexOf = __webpack_require__(26);

var _sortedIndexOf2 = _interopRequireDefault(_sortedIndexOf);

var _commitHistory = __webpack_require__(27);

var _commitHistory2 = _interopRequireDefault(_commitHistory);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var history = exports.history = (0, _get2.default)(_commitHistory2.default, 'history');

var series = exports.series = (0, _get2.default)(_commitHistory2.default, 'series');

var summary = exports.summary = (0, _get2.default)(_commitHistory2.default, 'summary');

var day = exports.day = function day(dateString) {
  return (0, _get2.default)(history, dateString);
};

var currentIndex = exports.currentIndex = function currentIndex(dateString) {
  return (0, _sortedIndexOf2.default)(series, dateString);
};

var previous = exports.previous = function previous(dateString) {
  var index = currentIndex(dateString);
  if (index > 0) {
...
var next = exports.next = function next(dateString) {
  var index = currentIndex(dateString);
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        'p',
        null,
        'Celebrating my decade on GitHub.'
      )
    ),
    _react2.default.createElement(
      'nav',
      ...
      _react2.default.createElement(
        _reactStatic.Link,
        { className: 'begin', to: '/day/2008-12-06' },
        'Begin'
      )
    ),
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          _reactStatic.Link,
          { className: 'commits', to: '/day/2008-12-06' },
          _commitHistory.summary.commitCount,
          ' Commits'
        )
      ),
      _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          'a',
          { href: 'mailto:david@mckelveycreative.co' },
          'David'
        )
      )
    ),
...
var Footer = function Footer() {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        'a',
        { href: 'https://sitesmade4people.co' },
...
var _Count = __webpack_require__(31);
...
var initialState = function initialState(props) {
  ...
  var index = (0, _commitHistory.currentIndex)(date);
  return {
    index: index,
    playing: index === 0
  };
      ...
      if (date) {
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              _reactStatic.Link,
              { className: 'home', exact: true, to: '/' },
              'Home'
            ),
            _react2.default.createElement(
              _reactStatic.Link,
              { className: 'restart', to: '/day/2008-12-06' },
              'Day'
            ),
            playing && _react2.default.createElement(
              _reactStatic.Link,
              { className: 'pause', to: '/day/' + _commitHistory.series[index] },
              'Day'
            ),
            !playing && _react2.default.createElement(
              'button',
          ...
          _react2.default.createElement(
            ...
            counts && _react2.default.createElement(_Count2.default, {
              ...
              term: 'commits',
              total: _commitHistory.summary.commitCount
            })
          ),
          _react2.default.createElement(_Footer2.default, null)
        );
...
exports.default = (0, _reactStatic.withRouter)(Day);
...
var _reactUniversalComponent = __webpack_require__(9);
...
var Day = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  path: function path() {
    return _path3.default.join(__dirname, './pages/Day');
  },
...
var randomInteger = function randomInteger(maximum) {
  return Math.floor(Math.random() * Math.floor(maximum));
};

var colors = (0, _shuffle2.default)(['yellow', 'orange', 'teal', 'blue']);
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'title',
              null,
              'TEN : My Decade on GitHub'
            ),
            _react2.default.createElement('link', { rel: 'icon', type: 'image/png', href: '/favicons/favicon-16x16.png', sizes: '16x16' }),
            ...
            _react2.default.createElement('link', { rel: 'apple-touch-icon', href: '/favicons/apple-touch-icon-120x120.png', sizes: '120x120' }),
            _react2.default.createElement('link', { rel: 'apple-touch-icon', href: '/favicons/apple-touch-icon-152x152.png', sizes: '152x152' }),
            _react2.default.createElement('link', { rel: 'apple-touch-icon', href: '/favicons/apple-touch-icon-167x167.png', sizes: '167x167' }),
            _react2.default.createElement('link', { rel: 'apple-touch-icon', href: '/favicons/apple-touch-icon-180x180.png', sizes: '180x180' }),
            _react2.default.createElement('meta', { name: 'msapplication-TileColor', content: '#ffffff' }),
            _react2.default.createElement('meta', { name: 'msapplication-TileImage', content: '/browserconfig.xml' }),
            _react2.default.createElement('link', { href: 'https://fonts.googleapis.com/css?family=Roboto:400,500|Zilla+Slab:500,700&subset=latin-ext', rel: 'stylesheet' }),
            _react2.default.createElement('meta', { name: 'keywords', content: 'mckelvey github git repository commit count decade ten years' }),
            _react2.default.createElement('meta', { name: 'twitter:title', content: 'TEN : My Decade on GitHub' }),
            _react2.default.createElement('meta', { property: 'og:title', content: 'TEN : My Decade on GitHub' }),
            _react2.default.createElement('meta', { name: 'twitter:image', content: '/favicons/share.png' }),
            _react2.default.createElement('meta', { property: 'og:image', content: '/favicons/share.png' }),
            ...
            _react2.default.createElement('meta', { name: 'twitter:image:alt', content: 'TEN : My Decade on GitHub' }),
            _react2.default.createElement('meta', { name: 'description', content: 'This is a simple and fun celebration of my decade on GitHub.' }),
            _react2.default.createElement('meta', { name: 'twitter:description', content: 'This is a simple and fun celebration of my decade on GitHub.' }),
            _react2.default.createElement('meta', { property: 'og:description', content: 'This is a simple and fun celebration of my decade on GitHub.' }),
            _react2.default.createElement('meta', { property: 'og:type', content: 'website' }),
            _react2.default.createElement('meta', { property: 'og:site_name', content: 'TEN : My Decade on GitHub' }),
            _react2.default.createElement('meta', { property: 'og:url', content: 'https://mckelvey.github.io/ten/' }),
            _react2.default.createElement('meta', { name: 'twitter:site', content: '@mckelvey' }),
            _react2.default.createElement('meta', { name: 'twitter:card', content: 'summary_large_image' })
          ),
          _react2.default.createElement(
            _reactStatic.Switch,
            null,
            _react2.default.createElement(_reactStatic.Route, { path: '/day/:date', component: Day }),
...
var Graph = function (_React$PureComponent) {
  ...
  _createClass(Graph, [{
    ...
    key: 'scrollToDate',
    value: function scrollToDate() {
      if (this.root) {
        var _props = this.props,
            barWidth = _props.barWidth,
            currentDate = _props.date;

        this.root.scrollLeft = (0, _commitHistory.currentIndex)(currentDate) * barWidth;
      }
    }
  }, {
    key: 'handleClick',
    ...
    value: function renderCommit(currentIndex, date, index) {
      var _props2 = this.props,
          ...
          divisor = _props2.divisor,
          height = _props2.height,
          segments = _props2.segments;

      var _day = (0, _commitHistory.day)(date),
          count = _day.count;

      if (typeof count === 'number') {
        var barHeight = 0;
        if (count <= breakpoints.one) {
          barHeight = height / divisor * segments.one / breakpoints.one * count;
        } else if (count <= breakpoints.two) {
          barHeight = height / divisor * segments.two / (breakpoints.two - breakpoints.one) * (count - breakpoints.one) + height / divisor * segments.one;
        } else {
          // less than breakpoints.three
          barHeight = height / divisor * segments.three / (breakpoints.three - breakpoints.two) * (count - breakpoints.two) + height / divisor * (segments.one + segments.two);
        }
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'svg',
          {
            viewBox: '0 0 ' + _commitHistory.summary.dayCount * barWidth + ' ' + (height + barWidth),
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement('path', {
              className: 'base',
              d: 'M 0,' + height + ' L ' + _commitHistory.summary.dayCount * barWidth + ',' + height + ' Z'
            }),
            _react2.default.createElement('path', {
              d: 'M 0,' + height / divisor * segments.one + ' L ' + _commitHistory.summary.dayCount * barWidth + ',' + height / divisor * segments.one + ' Z'
            }),
            _react2.default.createElement('path', {
              d: 'M 0,' + height / divisor * (segments.one + segments.two) + ' L ' + _commitHistory.summary.dayCount * barWidth + ',' + height / divisor * (segments.one + segments.two) + ' Z'
            })
          ),
          _react2.default.createElement(
            'g',
...
Graph.propTypes = {
  ...
  breakpoints: _propTypes2.default.shape({
    one: _propTypes2.default.number.isRequired,
    two: _propTypes2.default.number.isRequired,
    three: _propTypes2.default.number.isRequired
  }),
  currentIndex: _propTypes2.default.number.isRequired,
  divisor: _propTypes2.default.number,
  height: _propTypes2.default.number,
  segments: _propTypes2.default.shape({
    one: _propTypes2.default.number.isRequired,
    two: _propTypes2.default.number.isRequired,
    three: _propTypes2.default.number.isRequired
  })
